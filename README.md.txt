...
You can interact with all of the pets or interact with an individiual one, though watch out! Some actions can only be performed on live pets and some can only be performed on robotic pets.
